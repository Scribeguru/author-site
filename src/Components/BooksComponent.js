...
export default function Books() {
    ...
    return (
        <Container className='foundation'>
            <Row className='my-5 text-end'>
                <Col sm='12' md='6'>
                    <img className='img-fluid my-5 booksImg' src='./mockup.png' />
                    <Col className='buyLink my-1'>
